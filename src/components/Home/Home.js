                        ...
                        <div className="mr-lg-auto mt-3 col-lg-4 col-md-6 col-12">
                            <div className="about-working-hours">
                                <div>
                                    ...
                                    <strong className="mt-3 d-block" data-aos="fade-up" data-aos-delay="700">Monday - Saturday</strong>

                                    <p data-aos="fade-up" data-aos-delay="800">By appointment</p>

                                    <strong className="d-block" data-aos="fade-up" data-aos-delay="600">Sunday</strong>
